...
def plan_pick_and_place(req):
    ...
    print("print move_group: \n", move_group)
    print("print pick_pose: \n", req.pick_pose)
    print("print previous_ending_joint_angles: \n", current_robot_joint_configuration)
...
def moveit_server():
    ...
    rospy.init_node('baxter_moveit_server_right')

    s = rospy.Service('baxter_moveit_right_arm_trajectory', TrajectoryService, plan_pick_and_place)
