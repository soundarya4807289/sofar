...
from moveit_msgs.msg import Constraints, JointConstraint, PositionConstraint, OrientationConstraint, BoundingVolume, CollisionObject
...
def plan_pick_and_place(req):
    ...
    pre_grasp_pose = plan_trajectory(move_group, req.pick_pose,
    current_robot_joint_configuration)
    ...
    print("print pick_up_pose:", pick_up_pose)
    ...
    #print("print place_pose:",place_pose)
...
def moveit_server():
    ...
    rospy.init_node('baxter_moveit_server_left')

    s = rospy.Service('baxter_moveit_left_arm_trajectory', TrajectoryService, plan_pick_and_place)
    ...
    p.pose.position.x = 0.7673182
    p.pose.position.y = 0.0
    p.pose.position.z = 0.4
    p.pose.orientation.w = 0.4
